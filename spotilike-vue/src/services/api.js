...
export const albumsService = {
  // GET /api/albums - Récupère la liste de tous les albums
  getAllAlbums() {
    return apiClient.get('/albums');
  },
  
  // GET /api/albums/:id - Récupère les détails de l'album précisé par :id
  getAlbumById(id) {
  ...
  // POST /api/albums - Ajout d'un album
  ...
  // PUT /api/albums/:id - Modification de l'album précisé par :id
  updateAlbum(id, albumData) {
    return apiClient.put(`/albums/${id}`, albumData);
  },
  
  // DELETE /api/albums/:id - Suppression de l'album précisé par :id
  deleteAlbum(id) {
...
export const artistsService = {
  ...
  // GET /api/artists - Récupère la liste de tous les artistes
  getAllArtists() {
    return apiClient.get('/artists');
  },

  // POST /api/artists - Ajout d'un artiste
  createArtist(artistData) {
    return apiClient.post('/artists', artistData);
  },
  
  // PUT /api/artists/:id - Modification de l'artiste précisé par :id
  updateArtist(id, artistData) {
    return apiClient.put(`/artists/${id}`, artistData);
  },
  
  // DELETE /api/artists/:id - Suppression de l'artiste précisé par :id
  deleteArtist(id) {
...
export const genresService = {
  // GET /api/genres - Récupère la liste de tous les genres
  getAllGenres() {
    return apiClient.get('/genres');
  },
  
  // PUT /api/genres/:id - Modification du genre précisé par :id
...
export const usersService = {
  // POST /api/users/signup - Ajout d'un utilisateur (géré par authService)
  // POST /api/users/login - Connexion d'un utilisateur (géré par authService)
  // DELETE /api/users/:id - Suppression de l'utilisateur précisé par :id
  deleteUser(id) {
